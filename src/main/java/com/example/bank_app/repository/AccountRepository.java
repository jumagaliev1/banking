...
public interface AccountRepository extends CrudRepository<Account, Integer> {
    ...
    int getAccountIDByAccountNo(@Param("account_number") String account_number);

    @Query(value = "SELECT user_id FROM accounts WHERE account_number = :account_number", nativeQuery = true)
    int getUserIDByAccountNo(@Param("account_number") String account_number);
