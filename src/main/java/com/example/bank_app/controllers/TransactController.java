...
import com.example.bank_app.repository.PaymentRepository;
import com.example.bank_app.repository.TransactRepository;
...
public class TransactController {
    ...
    public String payment(@RequestParam("beneficiary")String beneficiary,
        ...
        int des_acc_id = accountRepository.getAccountIDByAccountNo(account_number);
        int des_user_id = accountRepository.getUserIDByAccountNo(account_number);
        double des_balance = accountRepository.getAccountBalance(des_user_id, des_acc_id);

        double des_newBalance = des_balance + paymentAmount;

        accountRepository.changeAccountBalanceById(des_newBalance, des_acc_id);
